; ModuleID = 'SB_dmbs.cpp'
source_filename = "SB_dmbs.cpp"
...
@.str.1 = private unnamed_addr constant [12 x i8] c"SB_dmbs.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_SB_dmbs.cpp, i8* null }]
...
cond.false:                                       ; preds = %lor.end
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i32 44, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_SB_dmbs.cpp() #0 section ".text.startup" {
entry:
