; ModuleID = 's_po_dmb.cpp'
source_filename = "s_po_dmb.cpp"
...
@.str.1 = private unnamed_addr constant [13 x i8] c"s_po_dmb.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_s_po_dmb.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_s_po_dmb.cpp() #0 section ".text.startup" {
entry:
