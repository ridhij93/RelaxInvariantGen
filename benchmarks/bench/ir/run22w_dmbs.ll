; ModuleID = 'run22w_dmbs.cpp'
source_filename = "run22w_dmbs.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_run22w_dmbs.cpp, i8* null }]
...
if.then:                                          ; preds = %land.lhs.true
  %call9 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0))
  %call10 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call9, i8 signext 10)
  br label %if.end
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_run22w_dmbs.cpp() #0 section ".text.startup" {
entry:
