...
@.str = private unnamed_addr constant [13 x i8] c"a!=1 || x!=2\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"corw.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_corw.cpp, i8* null }]
...
cond.false:                                       ; preds = %lor.end
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_corw.cpp() #0 section ".text.startup" {
entry:
