...
@.str = private unnamed_addr constant [42 x i8] c"( a != 1 || b != 1) && (a != 2 || b != 2)\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"corr2.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_corr2.cpp, i8* null }]
...
land.rhs:                                         ; preds = %lor.lhs.false, %entry
  ...
  %cmp19 = icmp ne i32 %14, 2
  br i1 %cmp19, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %land.rhs
  %15 = load i32, i32* @b, align 4
  %cmp20 = icmp ne i32 %15, 2
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %land.rhs
  %16 = phi i1 [ true, %land.rhs ], [ %cmp20, %lor.rhs ]
  br label %land.end

land.end:                                         ; preds = %lor.end, %lor.lhs.false
  %17 = phi i1 [ false, %lor.lhs.false ], [ %16, %lor.end ]
...
cond.false:                                       ; preds = %land.end
  call void @__assert_fail(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 62, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_corr2.cpp() #0 section ".text.startup" {
entry:
