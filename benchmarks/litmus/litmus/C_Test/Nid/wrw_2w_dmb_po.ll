...
@.str = private unnamed_addr constant [31 x i8] c"! ((x==2) && (y==2) && (a==1))\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"wrw_2w_dmb_po.c\00", align 1
...
; <label>:35                                      ; preds = %31
  call void @__assert_fail(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 45, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %37
