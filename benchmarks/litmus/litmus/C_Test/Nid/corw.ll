...
@.str = private unnamed_addr constant [17 x i8] c"! (a==1 && x==2)\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"corw.c\00", align 1
...
; <label>:24                                      ; preds = %20
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 35, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %26
