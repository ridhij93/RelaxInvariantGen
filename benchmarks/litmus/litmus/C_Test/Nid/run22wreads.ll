...
@.str = private unnamed_addr constant [18 x i8] c"!(a==1 && b == 1)\00", align 1
@.str.1 = private unnamed_addr constant [14 x i8] c"run22wreads.c\00", align 1
...
; <label>:40                                      ; preds = %36
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i32 57, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %42
