...
@.str = private unnamed_addr constant [20 x i8] c"!((y==2) && (a==1))\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"R_dmb_po.c\00", align 1
...
; <label>:24                                      ; preds = %20
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 39, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %26
